...
export class KnowledgeRepository {
  ...
  saveCase(value: Case): Case {
    ...
    this.store.db.prepare(`INSERT INTO knowledge_cases
      ...
      verification: value.verification ?? null, applicability: value.applicability ?? null, businessContext: JSON.stringify(value.businessContext ?? null), createdBy: value.createdBy ?? null,
