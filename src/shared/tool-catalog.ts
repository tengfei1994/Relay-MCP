...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: "relay_exec_remote", category: "remote-execution", description: "Execute a shell command through the explicit Relay MCP namespace." },
  { name: "relay_exec_remote_powershell", category: "remote-execution", description: "Execute PowerShell through the explicit Relay MCP namespace." },
  { name: "relay_exec_remote_script", category: "remote-execution", description: "Upload and execute a PowerShell script through the explicit Relay MCP namespace." },
