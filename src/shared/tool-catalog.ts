...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: "knowledge_search", category: "context", description: "Search ACL- and SampleManager-version-filtered Case, Pattern, Playbook, and Candidate knowledge." },
  { name: "knowledge_get", category: "context", description: "Read a complete Knowledge document after project ACL enforcement." },
