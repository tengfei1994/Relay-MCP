...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: "playwright_runtime_status", category: "remote-execution", description: "Read Agent-owned Node.js, Playwright, Chromium, and browser-cache readiness." },
  { name: "playwright_suite_list", category: "remote-execution", description: "List Playwright suites stored by the selected Agent." },
  { name: "playwright_suite_upload", category: "remote-execution", description: "Upload a Playwright test file and suite metadata with SHA-256 verification." },
  { name: "playwright_run_suite", category: "remote-execution", description: "Queue a formal Playwright test run through the dedicated Agent protocol." },
  { name: "playwright_run_status", category: "jobs", description: "Read a formal Playwright run record from the selected Agent." },
  { name: "playwright_artifact_list", category: "remote-files", description: "List bounded Playwright artifact metadata on the selected Agent." },
  { name: "playwright_artifact_download", category: "remote-files", description: "Transfer and verify a Playwright artifact through Relay into the project workspace." },
