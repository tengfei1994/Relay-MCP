  ...
  try {
    ...
    try {
      ...
      assert.deepEqual(versions, [
        ...
        "016-product-document-governance",
      "017-product-document-operations",
      "018-evidence-metadata",
      "019-human-display-projection", "020-observation-candidate", "021-observation-review", "022-chunk-fts-ownership", "023-business-context", "024-product-topics", "025-artifact-baselines", "026-source-index", "027-ingest-jobs", "028-product-revisions",
    ]);
