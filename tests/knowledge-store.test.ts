...
test("migrations tolerate a partially applied event_key column", async (t) => {
  ...
  try {
    ...
    try {
      ...
      "019-human-display-projection", "020-observation-candidate", "021-observation-review", "022-chunk-fts-ownership", "023-business-context", "024-product-topics", "025-artifact-baselines",
    ]);
